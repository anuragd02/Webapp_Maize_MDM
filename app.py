...
st.set_page_config(layout="wide", page_title="Maize Leaf Disease Classification (MDM)")
...
with col1:
    ...
    if uploaded_file is not None:
        ...
        if confidence >= 50:
            final_prediction = predicted_class + ": Maize Downy Mildew Disease"
...
with col2:
    ...
    st.markdown(
        ...
        **Common Maize Diseases:**
        - **Blight:** Caused by *Exserohilum turcicum*, leading to elongated lesions on leaves.
